 ...
 */
public class RangeFacetExample {
    ...
    public void index() throws IOException {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            doc.add(new StringField("timestamp", String.valueOf(then), Field.Store.YES));
...
*/
        q.add("timestamp", newLongRange("timestamp",
                Long.valueOf(range.min), Long.valueOf(range.max), true, true));
    ...
    public static void main(String[] args) throws Exception {
        RangeFacetExample example = new RangeFacetExample();
        example.index();
