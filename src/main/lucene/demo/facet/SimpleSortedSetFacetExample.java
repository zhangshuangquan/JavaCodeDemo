 ...
 */
public class SimpleSortedSetFacetExample {
    ...
    private List<FacetResult> search() throws IOException {
        ...
        Sort sort = new Sort(new SortField("Author", SortField.Type.INT, false));
        //FacetsCollector.search(searcher, new MatchAllDocsQuery(), 10, fc);
        TopDocs topDocs = FacetsCollector.search(searcher, new MatchAllDocsQuery(), 10, sort, true, false, fc);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("-----------------------");
        SimpleSortedSetFacetExample example = new SimpleSortedSetFacetExample();
