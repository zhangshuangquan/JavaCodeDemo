...
public class SimpleFacetTest {
    ...
    private void facetsWithSearch() throws IOException {
        ...
        DrillSideways.DrillSidewaysResult results = ds.search(drillDownQuery1, 10);
        result = results.facets.getAllDims(10);
        for (FacetResult tmp : result) {
            System.out.println(tmp);
        }
    ...
    public static void main(String[] args) throws Exception {
        SimpleFacetTest example = new SimpleFacetTest();
        example.index();
